...
class TestInlineModeHardGates(unittest.TestCase):
    ...
    def test_inline_mode_hard_gates(self):
        ...
        Shares the inline run with the smoke tests in
        test_example_pose_graph_runs.py; see slam_example_runner.
        """
        ...
        self.assertIn(
            "n_scans", summary, "HARD GATE 2 FAILED: Missing 'n_scans' in summary"
        )
        self.assertIn(
            "n_frontend_steps",
            summary,
        ...
        self.assertIn(
            "odom", rmse, "HARD GATE 4 FAILED: Missing 'rmse.odom' in summary"
        )
        self.assertIn(
        ...
        self.assertIn(
            "optimized", rmse, "HARD GATE 5 FAILED: Missing 'rmse.optimized' in summary"
        )
        ...
        print(
            f"  Optimized RMSE: {rmse['optimized']:.4f} ({improvement_pct:.1f}% improvement)"
        )
