...
class TestBatchUpdate(unittest.TestCase):
    ...
    def test_sequential_mode_runs(self):
        ...
        history = run_tc_fusion(
            self.dataset, use_gating=False, batch_update=False, verbose=False
        )
    ...
    def test_batch_mode_runs(self):
        ...
        history = run_tc_fusion(
            self.dataset, use_gating=False, batch_update=True, verbose=False
        )
    ...
    def test_batch_vs_sequential_update_count(self):
        ...
        self.assertLess(
            history_batch["n_uwb_accepted"], history_seq["n_uwb_accepted"] / 2
        )
    ...
    def test_batch_with_gating(self):
        ...
        history = run_tc_fusion(
            self.dataset, use_gating=True, batch_update=True, verbose=False
        )
    ...
    def test_batch_improves_gating_performance(self):
        ...
        """
        history_seq = run_tc_fusion(
            self.dataset, use_gating=True, batch_update=False, verbose=False
        )
